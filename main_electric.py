from envs.Electric import Electric
import numpy as np
from allocation_electric import Allocation,AllocationWoPre,AllocationNormalCritic,AllocationNormal
...
parser.add_argument('--model_dir',default="./models/Electric")
...
env = Electric()
args.agent_num,args.agent_dim = env.agent_num,env.agent_dim
